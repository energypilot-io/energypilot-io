...
export function GridLiveData({ device }: DeviceLiveDataProps) {
                    ...
                    setSeries((oldSeries: any) => {
                        return [
...

                            {
                                ...
                                data: [
                                    ...oldSeries[2].data,
                                    element.energy_export,
                                ].slice(-10),

                                datetimes: [
                                    ...oldSeries[2].datetimes,
                                    element.created_at,
                                ].slice(-10),
                            },
                        ]
